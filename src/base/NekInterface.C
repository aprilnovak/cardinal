			                     ...
			                     const nek_mesh::NekMeshEnum pp_mesh)
{
  ...
  // for quantities with a relative scaling, we need to add back the reference
  // contribution to the side integral
  integral += referenceAdditiveScale(integrand) * area(boundary_id, pp_mesh);
}
                             ...
                             const nek_mesh::NekMeshEnum pp_mesh)
{
  ...
  // for quantities with a relative scaling, we need to add back the reference
  // contribution to the mass flux integral
  total_integral += referenceAdditiveScale(integrand) * massFlowrate(boundary_id, pp_mesh);
