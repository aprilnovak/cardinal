# Understanding Multiphysics Instabilities in Picard Iterations

In this tutorial, you will learn where multiphysics instabilities during Picard
iterations come from, and how to:

- Achieve stable multiphysics simulations a variety of ways

To access this tutorial,

```
cd cardinal/tutorials/lwr_instability
```

## Multiphysics Instabilities

Multiphysics instabilities during Picard iteration typically manifest due to the operator-splitting
nature of multiphysics. For some systems, particularly those with strong negative reactivity coefficients,
large variations in the thermal-fluid state (e.g. large powers or small mass flowrates which lead
to large temperature and density differences spatially), and smaller neutron mean free path - exhibit Picard
instabilities that can result in failure to converge to a coupled solution.
