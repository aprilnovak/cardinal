...
At the outlet, a zero pressure is imposed. On the $\theta=0^\circ$ and
$\theta=7.5\circ$ boundaries, symmetry is imposed
...
oundaries 1, 2, and 7 are flux boundaries
...
and the symmetry conditions at $\theta=0^\circ$ and $\theta=7.5^\circ$, are clear in [velocity_cht].
